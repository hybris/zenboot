...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
    ...
    '/home/index':                          ['IS_AUTHENTICATED_FULLY'],
    '/executionZone/list':                  ['IS_AUTHENTICATED_FULLY'],
    '/executionZone/show':                  ['IS_AUTHENTICATED_FULLY'],
    '/executionZone/update':                ['IS_AUTHENTICATED_FULLY'],
    '/executionZone/ajaxGetParameters/**':  ['IS_AUTHENTICATED_FULLY'],
    '/executionZone/ajaxUserLike/**':       ['IS_AUTHENTICATED_FULLY'],
    '/executionZone/execute':               ['IS_AUTHENTICATED_FULLY'],
    '/scriptletBatch/list':                 ['IS_AUTHENTICATED_FULLY'],
    '/scriptletBatch/show':                 ['IS_AUTHENTICATED_FULLY'],
    '/exposedExecutionZoneAction/list':     ['IS_AUTHENTICATED_FULLY'],
    '/exposedExecutionZoneAction/show':     ['IS_AUTHENTICATED_FULLY'],
    '/exposedExecutionZoneAction/execute':  ['IS_AUTHENTICATED_FULLY'],
    '/scriptletBatch/ajaxList':             ['IS_AUTHENTICATED_FULLY'],
    '/host/list':                           ['IS_AUTHENTICATED_FULLY'],
    '/serviceUrl/list':                     ['IS_AUTHENTICATED_FULLY'],
    '/host/show':                           ['IS_AUTHENTICATED_FULLY'],
    '/serviceUrl/show':                     ['IS_AUTHENTICATED_FULLY'],
    '/executionZone/ajaxGetReadme':         ['IS_AUTHENTICATED_FULLY'],
    '/executionZoneRest/**':                ['IS_AUTHENTICATED_FULLY'],
    //default
